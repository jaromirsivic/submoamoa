...
/**
 * Demo page for testing Polygon component with zoom and pan functionality.
...
const PolygonZoomPanDemo = () => {
    ...
    return (
        <div className="page-container" style={{ padding: '1rem', display: 'flex', flexDirection: 'column', gap: '1rem', height: '100%' }}>
            <Panel header="Polygon Zoom & Pan Demo">
                <ColumnLayout>
                    <RowLayout>
                        <ComboBox
                            label="Stretch Mode"
                    ...
                    <StaticText
                        text="Controls: Ctrl+/- to zoom, Ctrl+0 to reset, Ctrl+Arrows to pan, Mouse wheel to zoom at cursor, Right-click drag to pan, Pinch gesture on touch devices"
